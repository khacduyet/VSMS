...
namespace VSMS.Areas.Admin.Controllers
{
    public class MembersController : CommonController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,UserName,PassWord,BirthDay,Email,Address,Phone,CreatedAt,Status")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,UserName,PassWord,BirthDay,Email,Address,Phone,CreatedAt,Status")] Member member)
        {
            if (ModelState.IsValid)
            {
