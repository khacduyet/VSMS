...
namespace VSMS.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : CommonController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CateName,Note,Status")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CateName,Note,Status")] Category category)
        {
            if (ModelState.IsValid)
            {
